        ...
        <div className="rounded-xl border border-orange-500/30 bg-orange-500/10 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-orange-500 bg-transparent px-4 py-2 text-sm font-semibold text-orange-500 hover:bg-orange-500/10 transition-colors"
            >
              Upgrade Now
