...
**Source-visible, not open source.** This code is public for portfolio purposes only — no license is granted to use, copy, modify, or distribute it. See [LICENSE](./LICENSE).
...
This source is publicly visible on GitHub for portfolio and demonstration
purposes only. It is **not** open source. No permission is granted to use,
copy, modify, or distribute this code without prior written permission from
the copyright holder. See [LICENSE](./LICENSE) for the full notice.
